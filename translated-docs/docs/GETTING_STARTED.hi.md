...
- **वर्कफ़लो 1 - यूआई अनुवाद**: किसी भी JS/TS स्रोत से `t("…")` कॉल निकालें, उन्हें OpenRouter के माध्यम से अनुवादित करें, और i18next के लिए तैयार प्रति-स्थानीयकरण JSON फ़ाइलें लिखें।
- **वर्कफ़लो 2 - दस्तावेज़ अनुवाद**: किसी भी संख्या में स्थानीयकरणों के लिए मार्कडाउन (MDX) और Docusaurus JSON लेबल फ़ाइलों का अनुवाद करें, स्मार्ट कैशिंग के साथ। **SVG** फ़ाइलों में `features.translateSVG`, शीर्ष-स्तरीय `svg` ब्लॉक और `translate-svg` का उपयोग किया जाता है (देखें [CLI संदर्भ](#cli-reference))।
...
मार्कडाउन दस्तावेज़ीकरण, Docusaurus साइट्स और JSON लेबल फ़ाइलों के लिए डिज़ाइन किया गया है। मार्कडाउन में एम्बेड की गई PNG और अन्य रास्टर छवियों के लिए, देखें [अनुवादित दस्तावेज़ों में छवियाँ और रास्टर संपत्ति](#images-and-raster-assets-in-translated-docs)। SVG फ़ाइलों का अनुवाद [`translate-svg`](#cli-reference) के माध्यम से किया जाता है जब `features.translateSVG` सक्षम है और शीर्ष-स्तरीय `svg` ब्लॉक सेट है — `documentations[].contentPaths` के माध्यम से नहीं।
...
**SVG** को चित्रित संपत्ति के रूप में उपयोग करने के लिए `svg` ब्लॉक और `translate-svg` का उपयोग करें — देखें [`svg`](#svg)। `documentations[].contentPaths` में सूचीबद्ध पथ मार्कडाउन/MDX (और वैकल्पिक JSON लेबल) के लिए हैं, स्वतंत्र SVG अनुवाद के लिए नहीं।
...
**पैटर्न 3 — स्टैंडअलोन SVG** (`examples/nextjs-app`)
...
- `description`
इस ब्लॉक के लिए वैकल्पिक मानव-पठनीय नोट (अनुवाद के लिए उपयोग नहीं किया जाता)। जब सेट किया जाए, तो `translate-docs` `🌐` हेडलाइन में उपसर्ग के रूप में जोड़ा जाता है; `status` अनुभाग हेडर में भी दिखाया जाता है।
- `contentPaths`
अनुवाद के लिए मार्कडाउन/MDX स्रोत (`translate-docs` इन्हें `.md` / `.mdx` के लिए स्कैन करता है)। JSON लेबल इसी ब्लॉक पर `jsonSource` से आते हैं।
- `outputDir`
इस ब्लॉक के लिए अनुवादित आउटपुट की जड़ निर्देशिका।
- `sourceFiles`
लोड करते समय `contentPaths` में मर्ज किया जाने वाला वैकल्पिक उपनाम।
- `targetLocales`
केवल इस ब्लॉक के लिए स्थानीयकरण का वैकल्पिक उपसमुच्चय (अन्यथा जड़ `targetLocales`)। प्रभावी दस्तावेज़ीकरण स्थानीयकरण ब्लॉकों में संघ हैं।
- `jsonSource`
इस ब्लॉक के लिए Docusaurus JSON लेबल फ़ाइलों की स्रोत निर्देशिका (उदाहरण के लिए `"i18n/en"`)।
- `markdownOutput.style`
`"nested"` (डिफ़ॉल्ट), `"docusaurus"`, या `"flat"`।
- `markdownOutput.docsRoot`
Docusaurus लेआउट के लिए स्रोत दस्तावेज़ जड़ (उदाहरण के लिए `"docs"`)।
