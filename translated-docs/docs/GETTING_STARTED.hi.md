...
- `sourceRoots`  
  निर्देशिकाएँ (cwd के सापेक्ष) जिन्हें `t("…")` कॉल के लिए स्कैन किया जाता है।
- `stringsJson`  
  मास्टर कैटलॉग फ़ाइल का पथ। `extract` द्वारा अपडेट किया गया।
- `flatOutputDir`  
  वह निर्देशिका जहाँ प्रति-स्थानीयकरण JSON फ़ाइलें लिखी जाती हैं (`de.json`, आदि)।
- `preferredModel`  
  वैकल्पिक। केवल `translate-ui` के लिए पहले आज़माया जाने वाला OpenRouter मॉडल आईडी; फिर `openrouter.translationModels` (या पुराने मॉडल) क्रम में, इस आईडी को दोहराए बिना।
...
| फ़ील्ड         | विवरण                                               |
|---------------|-----------------------------------------------------------|
| `sourceRoots` | निर्देशिकाएँ (cwd के सापेक्ष) जहाँ `t("…")` कॉल के लिए स्कैन किया जाता है। |
...
- `description`
इस ब्लॉक के लिए वैकल्पिक मानव-पठनीय नोट (अनुवाद के लिए उपयोग नहीं किया जाता है)। जब सेट किया जाता है, तो `translate-docs` `🌐` हेडलाइन में उपसर्गित किया जाता है; `status` अनुभाग हेडर में भी दिखाया जाता है।
- `contentPaths`
अनुवाद के लिए मार्कडाउन/MDX पृष्ठ बॉडी (`translate-docs` इन्हें `.md` / `.mdx` के लिए स्कैन करता है)। यहीं से स्थानीयकृत दस्तावेज़ीकरण लेखन आता है।
- `outputDir`
इस ब्लॉक के लिए अनुवादित आउटपुट के लिए मूल निर्देशिका।
- `sourceFiles`
लोड पर `contentPaths` में मर्ज किया जाने वाला वैकल्पिक उपनाम।
- `targetLocales`
...
`flat` शैली के लिए, स्रोत उपनिर्देशिकाओं को बनाए रखें ताकि समान बेसनेम वाली फ़ाइलें टकराएँ नहीं।
- `markdownOutput.rewriteRelativeLinks`
अनुवाद के बाद सापेक्ष लिंक को पुनः लिखें (`flat` शैली के लिए स्वचालित-सक्षम)।
