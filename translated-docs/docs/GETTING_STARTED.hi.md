...
- जब `translate-docs` या `sync` त्रुटियों, आंशिक भाषा-स्थानों, या भ्रमित करने वाले लॉग के साथ समाप्त हो जाए—आप केवल टर्मिनल आउटपुट को स्क्रॉल करने के बजाय विफलताओं को छाँट और फ़िल्टर कर सकते हैं।
- जब आप **पुनः कार्य को प्राथमिकता** देना चाहते हैं: **# विफलताएँ** के अनुसार छाँटें ताकि उन खंडों को पहले दिखाया जाए जो पुनः प्रयासों के दौरान बार-बार विफल रहे हों; ये खंड स्रोत मार्कडाउन में **सरल या पुनः स्वरूपित** करने के लिए मजबूत उम्मीदवार हैं ताकि भविष्य के प्रयास सफल हों।
- जब आपको सही पैराग्राफ को संपादित करने के लिए अपनी रिपोजिटरी में **सटीक खंड**—फ़ाइलपथ, पंक्ति संकेत, स्रोत हैश, और पूरा स्रोत पाठ—की आवश्यकता हो।
