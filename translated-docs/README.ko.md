...
각 명령어별 플래그 목록은 [명령어별 CLI 플래그](docs/GETTING_STARTED.ko.md#cli-flags-by-command)에서 `src/cli/index.ts` 옆에 정리되어 있습니다. 내장 사용법 텍스트를 보려면 `ai-i18n-tools <command> --help`을 실행하세요.
