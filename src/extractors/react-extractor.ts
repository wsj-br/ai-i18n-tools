...
import type { ReactExtractorConfig } from "../core/types.js";
...
/**
 * UI string extraction via `i18next-scanner` (Transrewrt-style). Segment hashes are **MD5 first 8 hex** (keys in `strings.json`).
 */
export class ReactExtractor extends BaseExtractor {
  readonly name = "react";
  ...
  constructor(
    config?: Partial<ReactExtractorConfig>,
