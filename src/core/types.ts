...
const i18nConfigSchemaInner = z
  .object({
     ...
     * The manifest at `languagesManifestPath` is generated by `extract` (and `generate-ui-languages`) from `sourceLocale` + this list.
     */
     ...
     */
    languagesManifestPath: z.string().optional(),
