...
- ~~write a compreensive documenation in astro or docusaurus and publish it as a website in Github Pages~~ [**DONE**]
- ~~separate the examples into different repositories to allow each example to be used as a standalone project~~ [**DONE**]
- ~~create a example of the plain HTML similar to the dashboard app~~ [**DONE**]
