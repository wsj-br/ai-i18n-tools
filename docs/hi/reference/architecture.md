...
- **अनुरोध टाइमआउट**: सक्रिय प्रदाता का `requestTimeoutMs` (डिफ़ॉल्ट 30 सेकंड) `AbortSignal.timeout` के माध्यम से प्रत्येक अनुरोध को रद्द कर देता है। जब CLI `check-models` (कोई भी प्रदाता) के लिए प्रदाता की मॉडल सूची लोड करता है तो `GET /models` पर वही मान लागू होता है। वैकल्पिक प्री-फ़्लाइट फ़िल्टर जो अज्ञात मॉडल आईडी को छोड़ देता है, केवल तभी चलता है जब सक्रिय प्रदाता OpenRouter हो।
...
- **डिबग ट्रैफ़िक लॉग**: यदि `debugTrafficFilePath` सेट है, तो अनुरोध और प्रतिक्रिया JSON को एक फ़ाइल (प्रोग्रामेटिक) में जोड़ता है। CLI `--debug-failed` `cacheDir` के तहत `FAILED-TRANSLATION` फ़ाइलें लिखता है जिसमें सिस्टम/उपयोगकर्ता प्रॉम्प्ट, कच्ची सहायक प्रतिक्रिया, और विफल UI, डॉक्स, JSON, और SVG प्रयासों के लिए सत्यापन त्रुटियाँ होती हैं।
