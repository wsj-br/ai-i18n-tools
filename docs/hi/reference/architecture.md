...
मॉडल वापस आने के बाद, `translate-docs` मैप्स को पुनर्स्थापित करता है और सेगमेंट को मान्य करता है: गैर-जोर वाले डबल-ब्रेसेज़ टोकन को संरक्षित स्रोत के समान क्रमबद्ध अनुक्रम रखना चाहिए (जोर मार्कर जैसे <code v-pre>{{SE}}</code> शब्द क्रम के साथ स्थानांतरित हो सकते हैं जब प्रति-प्रकार की संख्या मेल खाती हो), पुनर्स्थापित HTML टैग प्रकारों को असुरक्षित स्रोत से मेल खाना चाहिए, और कोई भी बचा हुआ डबल-ब्रेसेज़ पहचानकर्ता स्रोत में पहले से मौजूद होना चाहिए (इसलिए आविष्कार किए गए टोकन विफल हो जाते हैं)। दस्तावेज़ प्रॉम्प्ट मॉडल से प्रत्येक टोकन को एक बार कॉपी करने, क्रमांकित-टोकन क्रम रखने और नए डबल-ब्रेसेज़ रैपर का आविष्कार न करने के लिए भी कहता है; यांत्रिक जाँचें आधिकारिक बनी रहती हैं।
