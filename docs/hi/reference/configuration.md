...
`translate-docs` शब्दावली संकेतों के लिए समान शब्दावली का उपयोग करता है, लेकिन कॉम्पैक्ट UI-लेबल संक्षिप्ताक्षरों (जैसे `Alm.` जैसे ट्रेलिंग-डॉट फ़ॉर्म, या `Size` → `Tam` जैसे छोटे सिंगल-टोकन संपीड़न) को छोड़ देता है ताकि दस्तावेज़ प्रॉम्प्ट को आविष्कृत <code v-pre>{{…}}</code> टोकन की ओर निर्देशित न किया जाए। पूर्ण उत्पाद शब्द और गैर-संक्षिप्त UI अनुवाद अभी भी संकेतित हैं।
