...
1. डॉक्यूसॉरस के क्लासिक `{#…}` प्रत्यय (कॉमनमार्क) या एमडीएक्स टिप्पणी `{/* #… */}` (`.mdx` के लिए पसंदीदा) के साथ हेडिंग लाइन पर एक स्पष्ट आईडी जोड़ें, जैसे `## TLS configuration {#tls-configuration}` या `## TLS configuration {/* #tls-configuration */}`। `translate-docs` के दौरान, केवल दृश्यमान हेडिंग टेक्स्ट मॉडल को भेजा जाता है — आईडी प्रत्यय को पहले हटा दिया जाता है और अनुवादित हेडिंग लाइन के **अंत** में वापस पिन कर दिया जाता है (डॉक्यूसॉरस `{/* #id */}` को अनदेखा करता है जो शीर्षक के बीच में आता है)।
2. अपने डॉक्यूसॉरस प्रोजेक्ट रूट (अक्सर `pnpm run write-heading-ids` जब `package.json` में वायर्ड होता है) से `docusaurus write-heading-ids` चलाएँ ताकि उन शीर्षकों पर आईडी जोड़ी या ताज़ा की जा सकें जिनमें वे नहीं हैं — `{/* #… */}` फ़ॉर्म के लिए `--syntax mdx-comment` का उपयोग करें। वैकल्पिक रूप से उसी `docs[]` / `contentPaths` पर `ai-i18n-tools write-heading-ids --slug-style mdx-comment` चलाएँ। वह कमांड मौजूदा अनुवादित फ़ाइलों में समान अंग्रेजी आईडी को भी बदल देता है (यह अनुवादित शीर्षक को स्लग नहीं करता है)। शीर्षकों का नाम बदलने के बाद फिर से चलाएँ ताकि पुराने आईडी वर्तमान शीर्षकों से मेल खाएँ।
...
1. `translate-docs` से पहले अपने स्रोत `.md` / `.mdx` पर `ai-i18n-tools write-heading-ids` चलाएँ (सामान्य की तरह ही `docs[]` / `contentPaths`)। यह प्रत्येक शीर्षक से पहले की पंक्ति पर स्पष्ट HTML एंकर सम्मिलित करता है ताकि `id` मान प्रत्येक अनुवादित प्रतिलिपि द्वारा साझा किए जा सकें, और यह उन्हीं अंग्रेजी आईडी को मौजूदा अनुवादित फ़ाइलों पर कॉपी करता है। शीर्षकों का नाम बदलने के बाद इसे फिर से चलाएँ ताकि पुराने एंकर आईडी वर्तमान शीर्षक से मेल खाने के लिए ताज़ा हो जाएँ।
2. अपने मार्कडाउन **एंकर लिंक** को उन स्थिर आईडी पर इंगित करें, जैसे `[label](other.md#section-id)`, जहाँ `section-id` टूल द्वारा लिखे गए एंकर से मेल खाता है — केवल अंग्रेजी शब्दों से अनुमान नहीं।
