...
UI और दस्तावेज़ों के बीच **शब्दावली संगति** के लिए, `glossary.uiGlossary` को अपने `strings.json` पथ पर सेट करें — जब किसी खंड में मिलान करने वाले शब्द दिखाई देते हैं तो `translate-docs` LLM प्रॉम्प्ट में संकेतों के रूप में मौजूदा UI अनुवादों का पुन: उपयोग करता है। वैकल्पिक `glossary.userGlossary` उत्पाद शर्तों के लिए CSV ओवरराइड जोड़ता है (`translate-ui` और `proofread-ui` के साथ साझा किया गया)। `glossary-generate` के साथ एक स्टार्टर CSV जेनरेट करें, अनुवाद डैशबोर्ड **शब्दावली** टैब में पंक्तियों को संपादित करें, या [कॉन्फ़िगरेशन — `glossary`](/hi/reference/configuration#glossary) और [शब्दावली](/hi/guide/translation-dashboard/glossary) देखें।
...
पुनर्स्थापना के बाद, `translate-docs` उन खंडों को भी अस्वीकार करता है जहाँ HTML टैग प्लेसहोल्डर का पुन: उपयोग किया गया था या हटा दिया गया था (इसलिए पुनर्स्थापित टैग अब स्रोत मानचित्र से मेल नहीं खाते हैं) या जहाँ मॉडल ने बचे हुए डबल-ब्रेसेज़ टोकन का आविष्कार किया था जो स्रोत में नहीं थे (उदाहरण के लिए एक मनगढ़ंत शब्दावली-शैली टोकन)। वे विफलताएँ बचे हुए आधिकारिक आंतरिक टोकन के समान मॉडल-फ़ॉलबैक पथ का उपयोग करती हैं।
