...
पुनर्स्थापना के बाद, `translate-docs` उन खंडों को भी अस्वीकार करता है जहाँ HTML टैग प्लेसहोल्डर का पुन: उपयोग किया गया था या उन्हें हटा दिया गया था (इसलिए पुनर्स्थापित टैग अब स्रोत मानचित्र से मेल नहीं खाते) या जहाँ मॉडल ने बचे हुए डबल-ब्रेसेज़ टोकन का आविष्कार किया था जो स्रोत में नहीं थे (उदाहरण के लिए एक मनगढ़ंत शब्दावली-शैली टोकन)। पुनर्स्थापना-पूर्व जाँच के लिए <code v-pre>{{…}}</code> टोकन के समान मल्टीसेट और क्रमांकित टोकन के समान क्रमबद्ध अनुक्रम (<code v-pre>{{HTM_N}}</code>, <code v-pre>{{URL_N}}</code>, …) की आवश्यकता होती है; <code v-pre>{{SE}}</code> जैसे एम्फेसिस मार्कर प्राकृतिक शब्द क्रम के साथ स्थानांतरित हो सकते हैं जब उनकी प्रति-प्रकार की संख्या अभी भी मेल खाती हो। वे विफलताएँ बचे हुए आधिकारिक आंतरिक टोकन के समान मॉडल-फ़ॉलबैक पथ का उपयोग करती हैं।
