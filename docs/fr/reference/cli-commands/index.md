...
| Commande | Résumé |
|---------|---------|
| [`cleanup`](maintenance#cleanup) | Élimine les lignes de cache obsolètes/orphelines/de paramètres régionaux non configurés et repeuple les problèmes de markdown. |
