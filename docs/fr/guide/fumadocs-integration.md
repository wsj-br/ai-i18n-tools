...
Voir `ai-i18n-tools.config.dir.example.json` dans [examples/fumadocs-docs](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/fumadocs-docs/) pour une configuration de répertoire à copier-coller. Le modèle mental correspond à l'[intégration Nextra](/guide/nextra-integration#page-layout).
