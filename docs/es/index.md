...
<small id="lang-list">[Inglés (Reino Unido)](/) · [Alemán](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.de.md) · [Español](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.es.md) · [Francés](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.fr.md) · [Hindi (romano)](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.hi-Latn.md) · [Japonés](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.ja.md) · [Coreano](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.ko.md) · [Portugués (Brasil)](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.pt-BR.md) · [Chino simplificado](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.zh-Hans.md) · [Chino tradicional](https://github.com/wsj-br/ai-i18n-tools/blob/main/translated-docs/README.zh-Hant.md)</small>
...
Edite `ai-i18n-tools.config.json`: establezca `docs[].contentPaths` en fuentes markdown, MDX y/o `.astro`; `docs[].outputDir` y `docs[].docsOutput.style` (`"docusaurus"`, `"astro-starlight"`, `"vitepress"`, `"flat"`, etc.). Referencia de campo completa: [Documentos](/guide/documents/).

<a id="vitepress"></a>
### VitePress

`init -t ui-vitepress` genera `docsOutput.style: "vitepress"` más un bloque `json[]` para cadenas de tema/navegación/barra lateral. Ejecute `sync` para traducir el markdown de la página y `theme.{locale}.json` juntos. Consulte [Integración de VitePress](/guide/vitepress-integration) y [ejemplos/vitepress-docs](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/vitepress-docs/).
...
| `extractInterpolationNamesForWrap(key)`                                | Analiza los nombres <code v-pre>{{var}}</code> de una clave de origen para la reserva de `wrapT` / recorte de clave.                                                              |
...
| `interpolateTemplate(str, vars)`                                       | Sustitución de <code v-pre>{{var}}</code> de bajo nivel en una cadena simple (uso interno; el código de la aplicación debe usar `t()` en su lugar).                               |
...
- [Inicio rápido](/guide/quick-start) — configuración para cadenas de interfaz de usuario, documentos y JSON (UI, docs/`.astro`, paquetes JSON, Astro Starlight y Astro simple).
