...
1. Confirma que el diseño de tus recursos coincide con tu `docsOutput.style` (plano frente a sistema de documentos). Consulta [Reescritura de enlaces](/guide/documents/link-rewriting) e [Imágenes y capturas de pantalla](/guide/images-and-screenshots/).
