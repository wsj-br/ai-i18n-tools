...
`ai-i18n-tools.config.dir.example.json`을(를) [examples/fumadocs-docs](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/fumadocs-docs/)에서 참조하여 디렉토리 구성의 복사-貼付 예를 확인하십시오. 정신 모델은 [Nextra 통합](/guide/nextra-integration#page-layout)과 일치합니다.
