...
::: tip 면책 조항
제품명 및 아이콘은 각 소유주의 재산이며 식별 목적으로만 사용됩니다. 이 소프트웨어는 해당 브랜드와 제휴하지 않으며 공식 승인을 받지 않았습니다.

영어(영국)를 제외한 모든 인터페이스 및 문서 언어는 이 패키지(ai-i18n-tools)를 사용하여 AI로 번역되었으며, 일부 표현이 부정확하거나 오류가 포함될 수 있습니다.
:::
