...
Copie um exemplo sem clonar o repositório completo. Cada um declara um intervalo de circunflexo publicado de `ai-i18n-tools` correspondendo à versão atual do pacote e instala a CLI do npm:
