...
`localeLoaders` ko `makeLocaleLoadersFromManifest(uiLanguages, sourceLocale, …)` ke saath banayein taaki `generate-ui-languages` ke baad keys `targetLocales` ke saath align rahen. [Runtime wiring](/hi-Latn/guide/ui-strings/i18next-runtime), [nextjs-app](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/nextjs-app/), [console-app](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/console-app/), aur [astro-website](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/astro-website/) (i18next ke bina custom `makeT`) dekhein.
