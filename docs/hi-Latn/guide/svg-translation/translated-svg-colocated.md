...
[duplistatus](https://github.com/wsj-br/duplistatus) — [ai-i18n-tools.config.json](https://github.com/wsj-br/duplistatus/blob/master/ai-i18n-tools.config.json) mein `pathTemplate` ke saath nested `svg` block; source SVGs `documentation/static/img/` ke tahat soochibaddh hain (jaise [duplistatus_toolbar.svg](https://github.com/wsj-br/duplistatus/blob/master/documentation/static/img/duplistatus_toolbar.svg)); `translate-svg` colocated PNGs ke bagal mein `documentation/i18n/<locale>/…/current/assets/` mein per-locale files likhta hai; docs unhein aaj `/img/duplistatus_*.svg` ke madhyam se embed karte hain (jaise [overview.md](https://github.com/wsj-br/duplistatus/blob/master/documentation/docs/user-guide/overview.md)). `../assets/` paths aur SVG `regexAdjustments` bridge ko hatane ke liye [task-locale-assets-simplification.md](https://github.com/wsj-br/duplistatus/blob/master/dev/task-locale-assets-simplification.md) dekhein.
