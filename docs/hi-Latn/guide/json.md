...
| VitePress theme/nav/sidebar JSON (nested catalog jo aap banate hain) | JSON — `json[]` + `translate-json`; page bodies Documents mein rahte hain — [VitePress integration](/guide/vitepress-integration) dekhein |
