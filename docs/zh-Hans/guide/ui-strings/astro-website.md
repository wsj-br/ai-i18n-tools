...
对于静态 Astro 营销或应用网站（纯 Astro，非 Starlight），请将 [Astro 内置 i18n 路由](https://docs.astro.build/en/guides/internationalization/) 与 ai-i18n-tools 结合使用。另请参阅 [Astro 集成](/guide/astro-integration)。
