...
請**勿**將框架殼層/主題字串放入 `json[]` — 該管線用於不相關的應用程式語言套件。請參閱 [Docusaurus 整合](/guide/docusaurus-integration)、[VitePress 整合](/guide/vitepress-integration) 與 [Fumadocs 整合](/guide/fumadocs-integration) 以了解其他框架模式。
