...
請**勿**將框架 shell/主題字串放入 `json[]` —— 該管線用於無關的應用程式語言包。請參閱 [Docusaurus 整合](/guide/integrations/docusaurus)、[VitePress 整合](/guide/integrations/vitepress) 與 [Fumadocs 整合](/guide/integrations/fumadocs) 以了解其他框架模式。
