...
スクリーンショットのディレクトリレイアウト、フラットな深さプレフィックス + ロケールスワップのフロー、およびレイアウト固有のアセット例については、[画像とスクリーンショット — リンクの書き換え](/ja/guide/images-and-screenshots/link-rewriting) を参照してください。
