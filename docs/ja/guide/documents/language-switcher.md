...
| 例 | ファイル |
|---|---|
| このパッケージ (フラット README + VitePress サイト) | [ai-i18n-tools.config.json](https://github.com/wsj-br/ai-i18n-tools/blob/main/ai-i18n-tools.config.json) (README ブロック: `docsOutput.style = "flat"`; サイトブロック: `docsOutput.style = "vitepress"`; `json[]` 経由のテーマ JSON) |
...
| VitePress ドキュメント (最小限のデモ) | [examples/vitepress-docs/ai-i18n-tools.config.json](https://github.com/wsj-br/ai-i18n-tools/blob/main/examples/vitepress-docs/ai-i18n-tools.config.json) (`docsOutput.style = "vitepress"` + `json[]` テーマカタログ) |
