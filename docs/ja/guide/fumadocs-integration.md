...
コピー＆ペースト可能なdir設定については、[examples/fumadocs-docs](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/fumadocs-docs/)の`ai-i18n-tools.config.dir.example.json`を参照してください。メンタルモデルは[Nextra統合](/guide/nextra-integration#page-layout)と一致します。
