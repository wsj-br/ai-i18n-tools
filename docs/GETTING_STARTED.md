...
| `cleanup [--dry-run] [--no-backup] [--backup <path>]`                                                      | Runs `sync --force-update` first (extract, UI, SVG, docs), then removes stale segment rows (null `last_hit_at` / empty filepath); drops `file_tracking` rows whose resolved source path is missing on disk; removes translation rows whose `filepath` metadata points at a missing file; prunes orphaned `translation_failures` rows. Logs four counts (stale segments, orphaned `file_tracking`, orphaned translations, orphaned failures). Creates a timestamped SQLite backup under the cache dir unless `--no-backup`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
