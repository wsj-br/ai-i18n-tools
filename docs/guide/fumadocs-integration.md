...
See `ai-i18n-tools.config.dir.example.json` in [examples/fumadocs-docs](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/fumadocs-docs/) for a copy-paste dir config. Mental model matches [Nextra integration](/guide/nextra-integration#page-layout).
