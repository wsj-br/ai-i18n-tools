...
| VitePress theme/nav/sidebar strings | Documents — `docsOutput.vitepressThemeCatalog` + `translate-docs`; **do not** use `json[]` — see [VitePress integration](/guide/integrations/vitepress) |
