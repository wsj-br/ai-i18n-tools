...
| [plain-html](/examples#plain-html) | Static HTML with `data-i18n*` markers and locale JSON |
...
| [intlayer-migration](/examples#intlayer-migration) | Intlayer `.content.ts` → `t()` via `migrate-intlayer` |
