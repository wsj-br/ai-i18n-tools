...
| [plain-html](/de/examples#plain-html) | Statisches HTML mit `data-i18n*`-Markierungen und Locale-JSON |
...
| [intlayer-migration](/de/examples#intlayer-migration) | Intlayer `.content.ts` → `t()` über `migrate-intlayer` |
