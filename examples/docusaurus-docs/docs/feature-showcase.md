...
Markdown documents on this site show **document** translation. **Plural** behaviour for UI copy is easiest to see in the [Next.js example](https://github.com/wsj-br/ai-i18n-tools/tree/main/examples/nextjs-app) (`examples/nextjs-app/`), which combines a React app with this same Docusaurus content model.
